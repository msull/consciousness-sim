...
from local_utils.brainv2 import ArtworkDoesNotExist, BlogEntry, BrainV2, GeneratedArt, JournalEntry
...
def render_ai_output_blog(brain: BrainV2, entry: BlogEntry):
    brain.personas.get_persona_by_name(entry.persona_name)
    st.divider()
